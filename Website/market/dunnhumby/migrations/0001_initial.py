...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name="Campaign",
            fields=[
                ("campaign", models.IntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("trans_time", models.DecimalField(decimal_places=2, max_digits=10)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("min_confidence_threshold", models.FloatField(blank=True, null=True)),
                ("min_lift_threshold", models.FloatField(blank=True, null=True)),
                (
                    "source_view",
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["support"], name="dunnhumby_a_support_853ef1_idx"
                    ),
                    models.Index(
                        fields=["confidence"], name="dunnhumby_a_confide_679d71_idx"
                    ),
                    models.Index(fields=["lift"], name="dunnhumby_a_lift_a99612_idx"),
                    models.Index(
                        fields=["rule_type"], name="dunnhumby_a_rule_ty_c2743d_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["household_key"], name="dunnhumby_b_househo_571753_idx"
                    ),
                    models.Index(
                        fields=["basket_id"], name="dunnhumby_b_basket__a65eaf_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.FloatField(
                        blank=True,
                        default=0.0,
                        help_text="احتمال پیش\u200cبینی شده توسط مدل برای ریزش این مشتری.",
                        null=True,
                    ),
                ),
            ],
            options={
                "indexes": [
                    models.Index(
                        fields=["rfm_segment"], name="dunnhumby_c_rfm_seg_17b9d3_idx"
                    ),
                    models.Index(
                        fields=["recency_score", "frequency_score", "monetary_score"],
                        name="dunnhumby_c_recency_ae81c7_idx",
                    ),
                ],
            },
        ),
